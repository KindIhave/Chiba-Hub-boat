    ...
    local SOMEXHUB = library:AddWindow("Chiba HuB",Enum.KeyCode.RightControl)
    ...
    Main:AddLabel("welcome to Chiba Hub")
...
Main:AddToggle("เปิดฟามทอง or AutoFarm Gold",false,function(vn)
ps = vn
_G.AutoFarm = vn
